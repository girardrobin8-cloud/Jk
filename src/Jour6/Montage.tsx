...
/**
 * Montage complet — Reel Jour 6, « les courbatures », 47,96 s.
 *
 ...
 * ── La piste ────────────────────────────────────────────────────────────
 *
 * Blancs resserrés (0,75 s) et niveau NORMALISÉ, contrairement aux cinq vidéos
 * précédentes : la prise arrivait à -8,9 LUFS avec un vrai crête à +0,7 dBFS,
...
const RUSH = "rushes/jour6_resserre.mp4";
