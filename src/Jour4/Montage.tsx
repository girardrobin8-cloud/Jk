...
/**
 * Montage complet — Reel Jour 4, « tu n'as pas 30 minutes chrono », 88,08 s.
 *
 ...
 *
 * La piste est cet export aux blancs resserrés (scripts/resserrer.py) : dix
 * tranches conservées, 3,09 s retirées, 91,17 s → 88,08 s. Le niveau n'est pas
 * retouché — -13,7 LUFS pour 3,9 LU d'amplitude, dans la ligne des trois vidéos précédentes.
 *
...
const PISTE = "rushes/jour4_resserre.mp4";
