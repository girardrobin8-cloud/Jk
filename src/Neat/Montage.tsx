...
/**
 * Montage complet — « NEAT / la dépense calorique cachée ».
 *
 * SANS VOIX : le script est original et la prise n'est pas encore enregistrée.
 * Les bornes de reperes.ts sont PRÉDITES — à partir du débit horloge des trois
 * prises déjà mesurées, pas recopiées du brief. L'avertissement en tête de ce
 * fichier-là explique le calcul.
 *
 * Pour brancher la voix le moment venu, trois gestes, le premier étant de loin
 * le plus important :
 *
 *   1. mesurer   python3 scripts/caler.py <prise.wav> neat
 *                puis reporter les bornes dans reperes.ts et ajuster DUREE.
 *   2. copier    la piste SANS réencodage dans public/voix/neat.mp4
