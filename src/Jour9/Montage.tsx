...
/**
 * Montage complet — Reel Jour 9, « immobile, c'est peut-être ta pire option », 34,00 s.
 *
 ...
 * ── La piste ────────────────────────────────────────────────────────────
 *
 * Blancs resserrés (2,63 s) et niveau NORMALISÉ, contrairement aux cinq vidéos
 * précédentes : la prise arrivait à -8,9 LUFS avec un vrai crête à +1,1 dBFS,
...
const RUSH = "rushes/jour9_resserre.mp4";
